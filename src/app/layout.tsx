...
export const metadata: Metadata = {
  ...
  description: "Discover our exclusive collection of luxury vehicles. Premium sports cars, sedans, and SUVs from prestigious manufacturers. Schedule your private viewing today.",
  keywords: "luxury cars, premium vehicles, exotic cars, luxury car dealership, sports cars, luxury sedans, premium SUVs",
  openGraph: {
    title: "Prestige Motors - Premium Luxury Car Dealership",
    description: "Discover our exclusive collection of luxury vehicles. Premium sports cars, sedans, and SUVs from prestigious manufacturers.",
    siteName: "Prestige Motors",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763480994400-bo96tdiu.jpg",
  ...
  twitter: {
    ...
    title: "Prestige Motors - Premium Luxury Car Dealership",
    description: "Discover our exclusive collection of luxury vehicles. Premium sports cars, sedans, and SUVs from prestigious manufacturers.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763480994400-bo96tdiu.jpg"]
  },
  robots: {
    index: true,
    follow: true
